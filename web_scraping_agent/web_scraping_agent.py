...
scraping_agent = Agent(
    ...
    llm=basic_llm,
    tools=[ScrapflyScrapeWebsiteTool(api_key=SCRAPFLY_API_KEY)],
    verbose=True,
)
...
scraping_task = Task(
    description="\n".join([
        ...
        "Use the web scraping tool to get the content from each product page.",
        "Extract information into a JSON object with key 'products' and value as an array of product objects.",
