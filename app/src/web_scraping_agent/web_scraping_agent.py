...
scraping_task = Task(
    description="\n".join([
        ...
        "Use the web scraping tool to extract content from each URL.",
        ...
        "Each product object should include as much information as available: page_url (original URL), product_title, product_image_url, product_url, product_current_price (numeric), product_specs (array of objects with specification_name and specification_value), suspicion_score (1-10), suspicion_reasons (array of strings).",
