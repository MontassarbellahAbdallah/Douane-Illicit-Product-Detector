...
scraping_task = Task(
    description="\n".join([
        ...
        "Each product object should include as much information as available: page_url (original URL), product_title, product_image_url, product_current_price (numeric), suspicion_score (1-10), suspicion_reasons (array of strings), and business attribution information (business_name, business_contact_email, business_contact_phone, business_address, business_registration_info, business_website, founder_creator_info).",
